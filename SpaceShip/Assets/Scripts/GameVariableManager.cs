...
public class GameVariableManager : MonoBehaviour {
	...
	public enum GameState { Menu, StartGame, LookAtStar, Crisis, BeginWeekUpdate, Combat, Management, DeployTroops, TransferResources, ResourceRecap, AIReact, EndWeek, EndGame }
