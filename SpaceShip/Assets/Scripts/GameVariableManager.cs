...
public class GameVariableManager : MonoBehaviour {
	...
	public enum GameState { Menu, StartGame, LookAtStar, Crisis, BeginWeekUpdate, View, Management, DeployTroops, TransferResources, ResourceRecap, Combat, AIReact, EndWeek, EndGame }
