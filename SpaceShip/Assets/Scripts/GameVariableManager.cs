...
public class GameVariableManager : MonoBehaviour {
	...
	public enum GameState { Menu, StartGame, LookAtStar, Crisis, BeginWeekUpdate, Management, DeployTroops, TransferResources, ResourceRecap, Combat, AIReact, EndWeek, EndGame }
